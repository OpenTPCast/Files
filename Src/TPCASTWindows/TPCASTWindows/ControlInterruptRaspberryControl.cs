...
namespace TPCASTWindows
{
	public class ControlInterruptRaspberryControl : UserControl
	{
		...
		public ControlInterruptRaspberryControl()
		{
			...
			this.pictureBox2.Image = LocalizeUtil.getImageFromResource(Localization.interrupt_battery);
		}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager arg_7E_0 = new ComponentResourceManager(typeof(ControlInterruptRaspberryControl));
