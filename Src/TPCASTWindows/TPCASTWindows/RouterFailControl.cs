...
{
	public class RouterFailControl : UserControl
	{
		public delegate void OnRetryClickDelegate();

		public RouterFailControl.OnRetryClickDelegate OnRetryClick;
		...
		{
			RouterFailControl.OnRetryClickDelegate expr_06 = this.OnRetryClick;
			if (expr_06 == null)
			{
				return;
			}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager arg_5D_0 = new ComponentResourceManager(typeof(RouterFailControl));
