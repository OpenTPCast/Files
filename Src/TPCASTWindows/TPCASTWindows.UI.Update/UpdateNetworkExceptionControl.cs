...
{
	public class UpdateNetworkExceptionControl : UserControl
	{
		public delegate void OnOkClickDelegate();

		public UpdateNetworkExceptionControl.OnOkClickDelegate OnOkClick;
		...
		public UpdateNetworkExceptionControl()
		{
		...
		{
			UpdateNetworkExceptionControl.OnOkClickDelegate expr_06 = this.OnOkClick;
			if (expr_06 == null)
			{
				return;
			}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager arg_5D_0 = new ComponentResourceManager(typeof(UpdateNetworkExceptionControl));
			...
			base.Name = "UpdateNetworkExceptionControl";
