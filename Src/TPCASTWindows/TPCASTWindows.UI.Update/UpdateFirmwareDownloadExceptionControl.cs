...
{
	public class UpdateFirmwareDownloadExceptionControl : UserControl
	{
		public delegate void OnRetryClickDelegate();

		public UpdateFirmwareDownloadExceptionControl.OnRetryClickDelegate OnRetryClick;
		...
		public UpdateFirmwareDownloadExceptionControl()
		{
		...
		{
			UpdateFirmwareDownloadExceptionControl.OnRetryClickDelegate expr_06 = this.OnRetryClick;
			if (expr_06 == null)
			{
				return;
			}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager arg_5D_0 = new ComponentResourceManager(typeof(UpdateFirmwareDownloadExceptionControl));
			...
			base.Name = "UpdateFirmwareDownloadExceptionControl";
